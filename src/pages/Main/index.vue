<template>
  <div class="layout">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          <b-nav-item-dropdown text="後台管理">
            ...
            <b-dropdown-item v-if="User.isAdmin" :to="{ name: 'user-manage' }">
              使用者管理
            </b-dropdown-item>
            <b-dropdown-item v-if="User.isAdmin" :to="{ name: 'sys-manage' }">
              系統管理
            </b-dropdown-item>
            <b-dropdown-item @click="doLogout"> 登出 </b-dropdown-item>
          </b-nav-item-dropdown>
          <b-nav-item :to="{ name: 'week-item' }"> 周選 </b-nav-item>
          <b-nav-item :to="{ name: 'month-item' }"> 月選 </b-nav-item>
          <b-nav-item :to="{ name: 'quotation' }"> 報價 </b-nav-item>
          <b-nav-item :to="{ name: 'history-analysis' }"> 歷史分析 </b-nav-item>
        </b-navbar-nav>
    ...
    <div class="layout-copy">2011-2019 &copy; JacWang</div>
  </div>
</template>
